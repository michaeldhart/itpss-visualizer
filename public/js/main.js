...
exports.BiasChartMaker = BiasChartMaker;
...
/***/ "./src/generalPopulationChartMaker.ts":
/*!********************************************!*\
  !*** ./src/generalPopulationChartMaker.ts ***!
  \********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.GeneralPopulationChartMaker = void 0;
const svg_js_1 = __webpack_require__(/*! @svgdotjs/svg.js */ "./node_modules/@svgdotjs/svg.js/dist/svg.esm.js");
const utils_1 = __webpack_require__(/*! ./utils */ "./src/utils.ts");
class GeneralPopulationChartMaker {
    ...
    insertLegendDot(id, color) {
        document.getElementById(id).innerHTML = "";
        var svg = svg_js_1.SVG().addTo(`#${id}`).size(this.dotSize, this.dotSize);
        const dot = svg.circle(this.dotSize)
            .attr({ fill: color });
    }
}
exports.GeneralPopulationChartMaker = GeneralPopulationChartMaker;
...
const generalPopulationChartMaker_1 = __webpack_require__(/*! ./generalPopulationChartMaker */ "./src/generalPopulationChartMaker.ts");
const utils_1 = __webpack_require__(/*! ./utils */ "./src/utils.ts");
...
function renderGeneralPopulation(width, height, statistics) {
    ...
    const chartMaker = new generalPopulationChartMaker_1.GeneralPopulationChartMaker(width, height, sampleSize);
    chartMaker.make(statistics);
    chartMaker.insertLegendDot("pop-legend-w", utils_1.Colors.BLUE);
    chartMaker.insertLegendDot("pop-legend-b", utils_1.Colors.RED);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.NoBiasChartMaker = void 0;
const svg_js_1 = __webpack_require__(/*! @svgdotjs/svg.js */ "./node_modules/@svgdotjs/svg.js/dist/svg.esm.js");
const utils_1 = __webpack_require__(/*! ./utils */ "./src/utils.ts");
